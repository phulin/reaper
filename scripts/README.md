...
- `apply_db_analysis_to_ghidra.py`: applies database-backed function names, summaries, and recovered struct definitions into a Ghidra project. It can target a specific imported program by name when a project contains multiple binaries.
